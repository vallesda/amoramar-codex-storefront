...
async function check() {
  ...
  if (!payload?.data || payload.errors?.length) throw new Error('GraphQL rechazó la consulta. Revisa permisos de productos y colecciones de Storefront.');
  ...
  console.log('Lectura de productos, variantes y disponibilidad: correcta.');
