...
Revisión: 17 de septiembre de 2026. Propuesta, todavía sin implementar.

Para el catálogo actual, usar CSS + Intersection Observer: aparición con opacidad y desplazamiento vertical de 8–12 px durante unos 300 ms, una sola vez al entrar en pantalla. No retrasar la primera fila ni bloquear enlaces o controles. Mantener el contenido visible si JavaScript falla y desactivar el efecto cuando el usuario prefiera movimiento reducido.
